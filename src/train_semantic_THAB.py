...
dataloader_train = DataLoader(depth_dataset_train, batch_size=8, shuffle=True, num_workers=16)

# depth_dataset_test = SemanticKitti(data_path_test, rotate=False, flip=False)
# dataloader_test = DataLoader(depth_dataset_test, batch_size=1, shuffle=False, num_workers=2)

# Depth Estimation Network
nocs_model = SemanticNetworkWithFPN(resnet_type='resnet34', meta_channel_dim=6, num_classes=20)
...
# Define optimizer
optimizer = optim.Adam(nocs_model.parameters(), lr=0.001)
...
# TensorBoard
save_path ='/home/appuser/data/train_semantic/Resnet34/'
